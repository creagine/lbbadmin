...
public class Siswa {
    ...
    public Siswa(String searchnameSiswa, String namaSiswa, String jurusanSiswa,
        ...
        this.kecamatanSiswa = kecamatanSiswa;
        this.kotaSiswa = kotaSiswa;
        this.provinsiSiswa = provinsiSiswa;
        this.agamaSiswa = agamaSiswa;
        this.kebangsaanSiswa = kebangsaanSiswa;
        this.nomorTelpSiswa = nomorTelpSiswa;
        this.nomorHpSiswa = nomorHpSiswa;
        this.emailSiswa = emailSiswa;
        this.passwordSiswa = passwordSiswa;
    }

    public String getSearchnameSiswa() {
        return searchnameSiswa;
    }

    public void setSearchnameSiswa(String searchnameSiswa) {
        this.searchnameSiswa = searchnameSiswa;
    }
    ...
    public String getKecamatanSiswa() {
        return kecamatanSiswa;
    }

    public void setKecamatanSiswa(String kecamatanSiswa) {
        this.kecamatanSiswa = kecamatanSiswa;
    }

    public String getKotaSiswa() {
        return kotaSiswa;
    }

    public void setKotaSiswa(String kotaSiswa) {
        this.kotaSiswa = kotaSiswa;
    }

    public String getProvinsiSiswa() {
        return provinsiSiswa;
    }

    public void setProvinsiSiswa(String provinsiSiswa) {
        this.provinsiSiswa = provinsiSiswa;
    }
    ...
    public String getKebangsaanSiswa() {
        return kebangsaanSiswa;
    }

    public void setKebangsaanSiswa(String kebangsaanSiswa) {
        this.kebangsaanSiswa = kebangsaanSiswa;
    }

    public String getNomorTelpSiswa() {
        return nomorTelpSiswa;
    }

    public void setNomorTelpSiswa(String nomorTelpSiswa) {
        this.nomorTelpSiswa = nomorTelpSiswa;
    }

    public String getNomorHpSiswa() {
        return nomorHpSiswa;
    }

    public void setNomorHpSiswa(String nomorHpSiswa) {
        this.nomorHpSiswa = nomorHpSiswa;
    }
