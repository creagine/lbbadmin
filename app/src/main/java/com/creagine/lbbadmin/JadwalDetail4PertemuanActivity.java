...
public class JadwalDetail4PertemuanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jadwal_detail4_pertemuan);
        ...
        spinnerBulan.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if(i > 0){
                    ...
                    Toast.makeText(JadwalDetail4PertemuanActivity.this, "Pilih bulan", Toast.LENGTH_SHORT).show();
        ...
        cardPekan1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(JadwalDetail4PertemuanActivity.this, PresensiDetailActivity.class);
